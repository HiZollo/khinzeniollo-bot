...
const text = 
  ...
  '\n' +
  '請在網站上閱讀題目，並到 #五週年活動專區 進行討論。當準備好答題後，使用 /levels 選擇你要的關卡進行回答。\n' +
  ...
  '- 如果回答的是外文單字，請全部小寫，就算是人名地名專有名詞英文月份星期德文名詞等都一樣。\n' +
  '  - 例如單字是 Ärztekammerpräsidentenkonferenz，請你回答 ärztekammerpräsidentenkonferenz\n' +
